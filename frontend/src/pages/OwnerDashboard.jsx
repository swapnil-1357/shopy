                        ...
                        <div className="flex gap-4 flex-wrap mb-4">
                            {sections.map((sec) => (
                                <button
                                    ...
                                    className={`px-4 py-2 rounded font-medium border ${sec === selectedSection
            ...
            <section className="mb-12 max-w-md">
                ...
                <form onSubmit={handleAddProduct} className="space-y-4">
                    ...
                    {uploadProgress > 0 && uploadProgress < 100 && (
                        <p>Uploading Image: {uploadProgress.toFixed(0)}%</p>
                    )}
                    <Button type="submit" disabled={loadingProductAdd || !selectedSection}>
